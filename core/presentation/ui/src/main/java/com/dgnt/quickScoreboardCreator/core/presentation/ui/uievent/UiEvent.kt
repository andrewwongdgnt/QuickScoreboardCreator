...
sealed interface UiEvent {
    data class LaunchScoreboard(val sportIdentifier: com.dgnt.quickScoreboardCreator.feature.sport.domain.model.SportIdentifier) : UiEvent
    data class SportDetails(val sportIdentifier: com.dgnt.quickScoreboardCreator.feature.sport.domain.model.SportIdentifier? = null) : UiEvent
    ...
    data class IntervalEditor(val currentTimeValue: Long, val index: Int, val sportIdentifier: com.dgnt.quickScoreboardCreator.feature.sport.domain.model.SportIdentifier) : UiEvent
