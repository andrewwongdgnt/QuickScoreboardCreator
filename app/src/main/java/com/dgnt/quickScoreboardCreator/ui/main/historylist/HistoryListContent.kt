                        ...
                        content = {
                            CardItemContent(
                                modifier = Modifier
                                    .fillMaxWidth(),
                                title = team.title,
                                description = "${getDayOfMonthSuffix(team.lastLookedAt.dayOfMonth)}, ${team.lastLookedAt.toString(DateTimeFormat.forPattern("h:mm a"))}",
    ...
    HistoryListInnerContent(
        ...
        categorizedHistoryList = listOf(
            CategorizedHistoryItemData(
                ...
                listOf(
                    HistoryItemData(1, "Tennis", ScoreboardIcon.TENNIS, DateTime(2024, 6, 2, 10, 0)),
                    HistoryItemData(2, "Tennis", ScoreboardIcon.TENNIS, DateTime(2024, 6, 1, 9, 0)),
                )
            ),
            CategorizedHistoryItemData(
                DateTime(2024, 5, 1, 0, 0),
                listOf(
                    HistoryItemData(4, "Basketball NBA", ScoreboardIcon.BASKETBALL, DateTime(2024, 5, 2, 14, 0)),
                    HistoryItemData(7, "Hockey NHL", ScoreboardIcon.HOCKEY, DateTime(2024, 5, 2, 10, 0)),
                )
            ),
            CategorizedHistoryItemData(
                DateTime(2024, 1, 1, 0, 0),
                listOf(
                    HistoryItemData(8, "Pick up bball", ScoreboardIcon.BASKETBALL, DateTime(2024, 1, 31, 16, 14)),
                    HistoryItemData(55, "Pick up bball", ScoreboardIcon.BASKETBALL, DateTime(2024, 1, 22, 16, 14)),
                    HistoryItemData(83, "Pick up bball", ScoreboardIcon.BASKETBALL, DateTime(2024, 1, 21, 16, 14)),
                )
            )
