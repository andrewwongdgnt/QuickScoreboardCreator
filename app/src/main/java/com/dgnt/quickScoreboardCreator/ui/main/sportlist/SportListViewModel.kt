...
class SportListViewModel @Inject constructor(
    ...
    fun onEdit(sportIdentifier: SportIdentifier) = sendUiEvent(UiEvent.SportDetails(sportIdentifier))
    ...
    fun onLaunch(sportIdentifier: SportIdentifier) = sendUiEvent(UiEvent.LaunchScoreboard(sportIdentifier))
